...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-5 py-5">
			...
			<!-- 로그인 시작 { -->
			<div id="mb_login" class="mem01_skin">
			    <div class="mbskin_box">
			        <h2 class="mem_title text-center"><i class="icon-logo-c"></i>에 오신것을 환영합니다.</h2>
			        ...
			        <fieldset id="login_fs">
			            ...
			            <div id="login_info" class="row">
			                <div class="login_if_auto chk_box col-6">
			                    <input type="checkbox" name="auto_login" id="login_auto_login" class="selec_chk">
			                    <label for="login_auto_login"><span></span> 자동로그인</label>  
			                </div>
			                <div class="login_if_lpl col-6">
			                    <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost" class="btn btn-secondary">정보찾기</a>  
			                </div>
			            </div>
			        </fieldset> 
			        </form>
